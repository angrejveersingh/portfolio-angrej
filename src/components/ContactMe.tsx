...
export default function ContactMe({}: Props) {
  ...
  return (
    <div  className='h-screen flex relative flex-col text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center'>
        <h3 className={`${styles.education} absolute top-24 uppercase tracking-[20px] text-gray-500 text-2xl`}>
        Contact
        </h3>

        <div className={`${styles.contactBody} flex absolute top-36 flex-col space-y-6 md:space-y-8 xl:space-y-10 `}>
