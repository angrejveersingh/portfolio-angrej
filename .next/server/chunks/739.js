...
module.exports = createProxy("/Users/angrej/Desktop/MyDevelopments/nextApps/portfolio/portfolio-angrej/node_modules/next/dist/client/components/app-router.js");
 //# sourceMappingURL=app-router.js.map
...
/* __next_internal_client_entry_do_not_use__  cjs */ 
const { createProxy  } = __webpack_require__(5985);
module.exports = createProxy("/Users/angrej/Desktop/MyDevelopments/nextApps/portfolio/portfolio-angrej/node_modules/next/dist/client/components/error-boundary.js");
 //# sourceMappingURL=error-boundary.js.map
...
/* __next_internal_client_entry_do_not_use__  cjs */ 
const { createProxy  } = __webpack_require__(5985);
module.exports = createProxy("/Users/angrej/Desktop/MyDevelopments/nextApps/portfolio/portfolio-angrej/node_modules/next/dist/client/components/layout-router.js");
 //# sourceMappingURL=layout-router.js.map
...
/* __next_internal_client_entry_do_not_use__  cjs */ 
const { createProxy  } = __webpack_require__(5985);
module.exports = createProxy("/Users/angrej/Desktop/MyDevelopments/nextApps/portfolio/portfolio-angrej/node_modules/next/dist/client/components/render-from-template-context.js");
 //# sourceMappingURL=render-from-template-context.js.map
...
/* __next_internal_client_entry_do_not_use__  cjs */ 
const { createProxy  } = __webpack_require__(5985);
module.exports = createProxy("/Users/angrej/Desktop/MyDevelopments/nextApps/portfolio/portfolio-angrej/node_modules/next/dist/client/components/static-generation-searchparams-bailout-provider.js");
 //# sourceMappingURL=static-generation-searchparams-bailout-provider.js.map
...
var LazyContext = (0,react_.createContext)({ strict: false });
...
function useFeatures(props, visualElement, preloadedFeatures) {
    var features = [];
    var lazyContext = (0,react_.useContext)(LazyContext);
    if (!visualElement)
        return null;
    /**
    ...
    for (var i = 0; i < numFeatures; i++) {
        ...
        if (isEnabled(props) && Component) {
            features.push(react_.createElement(Component, __assign({ key: name_1 }, props, { visualElement: visualElement })));
        }
    }
    return features;
}
 ...
 * @public
 */
var MotionConfigContext = (0,react_.createContext)({
...
var MotionContext = (0,react_.createContext)({});
 ...
 * @public
 */
var PresenceContext_PresenceContext = (0,react_.createContext)(null);
...
var useIsomorphicLayoutEffect = isBrowser ? react_.useLayoutEffect : react_.useEffect;
...
function useReducedMotion() {
    ...
    var _a = tslib_es6_read((0,react_.useState)(prefersReducedMotion.current), 1), shouldReduceMotion = _a[0];
    /**
...
function useReducedMotionConfig() {
    ...
    var reducedMotion = (0,react_.useContext)(MotionConfigContext).reducedMotion;
...
function useVisualElement(Component, visualState, props, createVisualElement) {
    ...
    var presenceContext = (0,react_.useContext)(PresenceContext_PresenceContext);
    var shouldReduceMotion = useReducedMotionConfig();
    var visualElementRef = (0,react_.useRef)(undefined);
    /**
...
function useMotionRef(visualState, visualElement, externalRef) {
    return (0,react_.useCallback)(function (instance) {
        var _a;
...
function useCreateMotionContext(props) {
    var _a = getCurrentTreeVariants(props, (0,react_.useContext)(MotionContext)), initial = _a.initial, animate = _a.animate;
    return (0,react_.useMemo)(function () { return ({ initial: initial, animate: animate }); }, [variantLabelsAsDependency(initial), variantLabelsAsDependency(animate)]);
}
...
var LayoutGroupContext = (0,react_.createContext)({});
 ...
 */
var SwitchLayoutGroupContext = (0,react_.createContext)({});
...
function useProjection(projectionId, _a, visualElement, ProjectionNodeConstructor) {
    ...
    var initialPromotionConfig = (0,react_.useContext)(SwitchLayoutGroupContext);
...
function motion_createMotionComponent(_a) {
    ...
    function MotionComponent(props, externalRef) {
         ...
         */
        var config = (0,react_.useContext)(MotionConfigContext);
        var features = null;
         ...
         */
        return (react_.createElement(VisualElementHandler, { visualElement: context.visualElement, props: __assign(__assign({}, config), props) },
            features,
            react_.createElement(MotionContext.Provider, { value: context }, useRender(Component, props, projectionId, useMotionRef(visualState, context.visualElement, externalRef), visualState, config.isStatic, context.visualElement))));
    }
    return (0,react_.forwardRef)(MotionComponent);
}
function useLayoutId(_a) {
    var _b;
    var layoutId = _a.layoutId;
    var layoutGroupId = (_b = (0,react_.useContext)(LayoutGroupContext)) === null || _b === void 0 ? void 0 : _b.id;
...
function useInitialMotionValues(_a, visualState, isStatic) {
    ...
    return (0,react_.useMemo)(function () {
...
function useSVGProps(props, visualState) {
    var visualProps = (0,react_.useMemo)(function () {
...
var makeUseVisualState = function (config) {
    return function (props, isStatic) {
        var context = (0,react_.useContext)(MotionContext);
        var presenceContext = (0,react_.useContext)(PresenceContext_PresenceContext);
        return isStatic
...
function useUnmountEffect(callback) {
    return (0,react_.useEffect)(function () { return function () { return callback(); }; }, []);
}
...
function useTapGesture(_a) {
    ...
    var isPressing = (0,react_.useRef)(false);
    var cancelPointerEndListeners = (0,react_.useRef)(null);
    /**
...
function usePresence() {
    var context = (0,react_.useContext)(PresenceContext_PresenceContext);
    if (context === null)
        return [true, null];
    ...
    var id = useId();
    (0,react_.useEffect)(function () { return register(id); }, []);
...
var easingDefinitionToFunction = function (definition) {
    if (Array.isArray(definition)) {
        ...
        (0,dist/* invariant */.kG)(easingLookup[definition] !== undefined, "Invalid easing type '".concat(definition, "'"));
...
function getAnimation(key, value, target, transition, onComplete) {
    ...
    (0,dist/* warning */.Kp)(isOriginAnimatable === isTargetAnimatable, "You are trying to animate ".concat(key, " from \"").concat(origin, "\" to \"").concat(target, "\". ").concat(origin, " is not an animatable value - to enable this animation set ").concat(origin, " to a value animatable to ").concat(target, " via the `style` property."));
    function start() {
        var options = {
            from: origin,
            to: target,
...
var animations = {
    animation: makeRenderlessComponent(function (_a) {
        ...
        if (isAnimationControls(animate)) {
            (0,react_.useEffect)(function () { return animate.subscribe(visualElement); }, [animate]);
        }
    }),
...
function useDrag(props) {
    ...
    (0,react_.useEffect)(function () { return groupDragControls && groupDragControls.subscribe(dragControls); }, [dragControls, groupDragControls]);
    // Apply the event listeners to the element
    (0,react_.useEffect)(function () { return dragControls.addListeners(); }, [dragControls]);
}
...
function usePanGesture(_a) {
    ...
    var panSession = (0,react_.useRef)(null);
    var transformPagePoint = (0,react_.useContext)(MotionConfigContext).transformPagePoint;
    var handlers = {
...
function getVariableValue(current, element, depth) {
    ...
    (0,dist/* invariant */.kG)(depth <= maxDepth, "Max CSS variable fallback depth detected in property \"".concat(current, "\". This may indicate a circular fallback dependency."));
...
function MeasureLayout(props) {
    var _a = tslib_es6_read(usePresence(), 2), isPresent = _a[0], safeToRemove = _a[1];
    var layoutGroup = (0,react_.useContext)(LayoutGroupContext);
    return (react_.createElement(MeasureLayoutWithContext, __assign({}, props, { layoutGroup: layoutGroup, switchLayoutGroup: (0,react_.useContext)(SwitchLayoutGroupContext), isPresent: isPresent, safeToRemove: safeToRemove })));
}
...
// UNUSED EXPORTS: TooltipProvider, TooltipWrapper
...
* @license MIT
*/
"use client";function h(e,t){void 0===t&&(t={});var r=t.insertAt;if(e&&"undefined"!=typeof document){var o=document.head||document.getElementsByTagName("head")[0],l=document.createElement("style");l.type="text/css","top"===r&&o.firstChild?o.insertBefore(l,o.firstChild):o.appendChild(l),l.styleSheet?l.styleSheet.cssText=e:l.appendChild(document.createTextNode(e))}}h(":root{--rt-color-white:#fff;--rt-color-dark:#222;--rt-color-success:#8dc572;--rt-color-error:#be6464;--rt-color-warning:#f0ad4e;--rt-color-info:#337ab7;--rt-opacity:0.9}");const f=(e,t,r)=>{let o=null;return function(...l){const n=()=>{o=null,r||e.apply(this,l)};r&&!o&&(e.apply(this,l),o=setTimeout(n,t)),r||(o&&clearTimeout(o),o=setTimeout(n,t))}},y="DEFAULT_TOOLTIP_ID",w={anchorRefs:new Set,activeAnchor:{current:null},attach:()=>{},detach:()=>{},setActiveAnchor:()=>{}},_=(0,react_.createContext)({getTooltipData:()=>w}),b=({children:t})=>{const[n,i]=r({[y]:new Set}),[c,a]=r({[y]:{current:null}}),s=(e,...t)=>{i((r=>{var o;const l=null!==(o=r[e])&&void 0!==o?o:new Set;return t.forEach((e=>l.add(e))),{...r,[e]:new Set(l)}}))},u=(e,...t)=>{i((r=>{const o=r[e];return o?(t.forEach((e=>o.delete(e))),{...r}):r}))},d=o(((e=y)=>{var t,r;return{anchorRefs:null!==(t=n[e])&&void 0!==t?t:new Set,activeAnchor:null!==(r=c[e])&&void 0!==r?r:{current:null},attach:(...t)=>s(e,...t),detach:(...t)=>u(e,...t),setActiveAnchor:t=>((e,t)=>{a((r=>{var o;return(null===(o=r[e])||void 0===o?void 0:o.current)===t.current?r:{...r,[e]:t}}))})(e,t)}}),[n,c,s,u]),p=l((()=>({getTooltipData:d})),[d]);return e.createElement(_.Provider,{value:p},t)};function g(e=y){return (0,react_.useContext)(_).getTooltipData(e)}const S=({tooltipId:t,children:r,className:o,place:l,content:n,html:a,variant:u,offset:d,wrapper:p,events:v,positionStrategy:m,delayShow:h,delayHide:f})=>{const{attach:y,detach:w}=g(t),_=i(null);return c((()=>(y(_),()=>{w(_)})),[]),e.createElement("span",{ref:_,className:s("react-tooltip-wrapper",o),"data-tooltip-place":l,"data-tooltip-content":n,"data-tooltip-html":a,"data-tooltip-variant":u,"data-tooltip-offset":d,"data-tooltip-wrapper":p,"data-tooltip-events":v,"data-tooltip-position-strategy":m,"data-tooltip-delay-show":h,"data-tooltip-delay-hide":f},r)},A="undefined"!=typeof window?react_.useLayoutEffect:react_.useEffect,k=async({elementReference:e=null,tooltipReference:t=null,tooltipArrowReference:r=null,place:o="top",offset:l=10,strategy:n="absolute",middlewares:i=[offset(Number(l)),flip(),shift({padding:5})]})=>{if(!e)return{tooltipStyles:{},tooltipArrowStyles:{},place:o};if(null===t)return{tooltipStyles:{},tooltipArrowStyles:{},place:o};const c=i;return r?(c.push(arrow({element:r,padding:5})),floating_ui_dom_computePosition(e,t,{placement:o,strategy:n,middleware:c}).then((({x:e,y:t,placement:r,middlewareData:o})=>{var l,n;const i={left:`${e}px`,top:`${t}px`},{x:c,y:a}=null!==(l=o.arrow)&&void 0!==l?l:{x:0,y:0};return{tooltipStyles:i,tooltipArrowStyles:{left:null!=c?`${c}px`:"",top:null!=a?`${a}px`:"",right:"",bottom:"",[null!==(n={top:"bottom",right:"left",bottom:"top",left:"right"}[r.split("-")[0]])&&void 0!==n?n:"bottom"]:"-4px"},place:r}}))):floating_ui_dom_computePosition(e,t,{placement:"bottom",strategy:n,middleware:c}).then((({x:e,y:t,placement:r})=>({tooltipStyles:{left:`${e}px`,top:`${t}px`},tooltipArrowStyles:{},place:r})))};var E={tooltip:"styles-module_tooltip__mnnfp",fixed:"styles-module_fixed__7ciUi",arrow:"styles-module_arrow__K0L3T",noArrow:"styles-module_noArrow__T8y2L",clickable:"styles-module_clickable__Bv9o7",show:"styles-module_show__2NboJ",dark:"styles-module_dark__xNqje",light:"styles-module_light__Z6W-X",success:"styles-module_success__A2AKt",warning:"styles-module_warning__SCK0X",error:"styles-module_error__JvumD",info:"styles-module_info__BWdHW"};h(".styles-module_tooltip__mnnfp{border-radius:3px;font-size:90%;left:0;opacity:0;padding:8px 16px;pointer-events:none;position:absolute;top:0;transition:opacity .3s ease-out;visibility:hidden;width:max-content;will-change:opacity,visibility}.styles-module_fixed__7ciUi{position:fixed}.styles-module_arrow__K0L3T{background:inherit;height:8px;position:absolute;transform:rotate(45deg);width:8px}.styles-module_noArrow__T8y2L{display:none}.styles-module_clickable__Bv9o7{pointer-events:auto}.styles-module_show__2NboJ{opacity:var(--rt-opacity);visibility:visible}.styles-module_dark__xNqje{background:var(--rt-color-dark);color:var(--rt-color-white)}.styles-module_light__Z6W-X{background-color:var(--rt-color-white);color:var(--rt-color-dark)}.styles-module_success__A2AKt{background-color:var(--rt-color-success);color:var(--rt-color-white)}.styles-module_warning__SCK0X{background-color:var(--rt-color-warning);color:var(--rt-color-white)}.styles-module_error__JvumD{background-color:var(--rt-color-error);color:var(--rt-color-white)}.styles-module_info__BWdHW{background-color:var(--rt-color-info);color:var(--rt-color-white)}");const T=({id:t,className:o,classNameArrow:l,variant:n="dark",anchorId:a,anchorSelect:u,place:d="top",offset:p=10,events:v=["hover"],openOnClick:m=!1,positionStrategy:h="absolute",middlewares:y,wrapper:w,delayShow:_=0,delayHide:b=0,float:S=!1,hidden:T=!1,noArrow:x=!1,clickable:N=!1,closeOnEsc:O=!1,style:L,position:R,afterShow:$,afterHide:C,content:H,contentWrapperRef:I,isOpen:W,setIsOpen:j,activeAnchor:q,setActiveAnchor:D})=>{const B=(0,react_.useRef)(null),K=(0,react_.useRef)(null),X=(0,react_.useRef)(null),J=(0,react_.useRef)(null),[M,z]=(0,react_.useState)(d),[U,F]=(0,react_.useState)({}),[P,Z]=(0,react_.useState)({}),[Y,G]=(0,react_.useState)(!1),[Q,V]=(0,react_.useState)(!1),ee=(0,react_.useRef)(!1),te=(0,react_.useRef)(null),{anchorRefs:re,setActiveAnchor:oe}=g(t),le=(0,react_.useRef)(!1),[ne,ie]=(0,react_.useState)([]),ce=(0,react_.useRef)(!1),ae=m||v.includes("click");A((()=>(ce.current=!0,()=>{ce.current=!1})),[]),(0,react_.useEffect)((()=>{if(!Y){const e=setTimeout((()=>{V(!1)}),150);return()=>{clearTimeout(e)}}return()=>null}),[Y]);const se=e=>{ce.current&&(e&&V(!0),setTimeout((()=>{ce.current&&(null==j||j(e),void 0===W&&G(e))}),10))};(0,react_.useEffect)((()=>{if(void 0===W)return()=>null;W&&V(!0);const e=setTimeout((()=>{G(W)}),10);return()=>{clearTimeout(e)}}),[W]),(0,react_.useEffect)((()=>{Y!==ee.current&&(ee.current=Y,Y?null==$||$():null==C||C())}),[Y]);const ue=(e=b)=>{J.current&&clearTimeout(J.current),J.current=setTimeout((()=>{le.current||se(!1)}),e)},de=e=>{var t;if(!e)return;const r=null!==(t=e.currentTarget)&&void 0!==t?t:e.target;if(!(null==r?void 0:r.isConnected))return D(null),void oe({current:null});_?(X.current&&clearTimeout(X.current),X.current=setTimeout((()=>{se(!0)}),_)):se(!0),D(r),oe({current:r}),J.current&&clearTimeout(J.current)},pe=()=>{N?ue(b||100):b?ue():se(!1),X.current&&clearTimeout(X.current)},ve=({x:e,y:t})=>{k({place:d,offset:p,elementReference:{getBoundingClientRect:()=>({x:e,y:t,width:0,height:0,top:t,left:e,right:e,bottom:t})},tooltipReference:B.current,tooltipArrowReference:K.current,strategy:h,middlewares:y}).then((e=>{Object.keys(e.tooltipStyles).length&&F(e.tooltipStyles),Object.keys(e.tooltipArrowStyles).length&&Z(e.tooltipArrowStyles),z(e.place)}))},me=e=>{if(!e)return;const t=e,r={x:t.clientX,y:t.clientY};ve(r),te.current=r},he=e=>{de(e),b&&ue()},fe=e=>{var t;[document.querySelector(`[id='${a}']`),...ne].some((t=>null==t?void 0:t.contains(e.target)))||(null===(t=B.current)||void 0===t?void 0:t.contains(e.target))||se(!1)},ye=e=>{"Escape"===e.key&&se(!1)},we=f(de,50,!0),_e=f(pe,50,!0);(0,react_.useEffect)((()=>{var e,t;const r=new Set(re);ne.forEach((e=>{r.add({current:e})}));const o=document.querySelector(`[id='${a}']`);o&&r.add({current:o}),O&&window.addEventListener("keydown",ye);const l=[];ae?(window.addEventListener("click",fe),l.push({event:"click",listener:he})):(l.push({event:"mouseenter",listener:we},{event:"mouseleave",listener:_e},{event:"focus",listener:we},{event:"blur",listener:_e}),S&&l.push({event:"mousemove",listener:me}));const n=()=>{le.current=!0},i=()=>{le.current=!1,pe()};return N&&!ae&&(null===(e=B.current)||void 0===e||e.addEventListener("mouseenter",n),null===(t=B.current)||void 0===t||t.addEventListener("mouseleave",i)),l.forEach((({event:e,listener:t})=>{r.forEach((r=>{var o;null===(o=r.current)||void 0===o||o.addEventListener(e,t)}))})),()=>{var e,t;ae&&window.removeEventListener("click",fe),O&&window.removeEventListener("keydown",ye),N&&!ae&&(null===(e=B.current)||void 0===e||e.removeEventListener("mouseenter",n),null===(t=B.current)||void 0===t||t.removeEventListener("mouseleave",i)),l.forEach((({event:e,listener:t})=>{r.forEach((r=>{var o;null===(o=r.current)||void 0===o||o.removeEventListener(e,t)}))}))}}),[Q,re,ne,O,v]),(0,react_.useEffect)((()=>{let e=null!=u?u:"";!e&&t&&(e=`[data-tooltip-id='${t}']`);const r=new MutationObserver((r=>{const o=[];r.forEach((r=>{if("attributes"===r.type&&"data-tooltip-id"===r.attributeName){r.target.getAttribute("data-tooltip-id")===t&&o.push(r.target)}if("childList"===r.type&&(q&&[...r.removedNodes].some((e=>{var t;return!!(null===(t=null==e?void 0:e.contains)||void 0===t?void 0:t.call(e,q))&&(V(!1),se(!1),D(null),!0)})),e))try{const t=[...r.addedNodes].filter((e=>1===e.nodeType));o.push(...t.filter((t=>t.matches(e)))),o.push(...t.flatMap((t=>[...t.querySelectorAll(e)])))}catch(e){}})),o.length&&ie((e=>[...e,...o]))}));return r.observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["data-tooltip-id"]}),()=>{r.disconnect()}}),[t,u,q]);const be=()=>{R?ve(R):S?te.current&&ve(te.current):k({place:d,offset:p,elementReference:q,tooltipReference:B.current,tooltipArrowReference:K.current,strategy:h,middlewares:y}).then((e=>{ce.current&&(Object.keys(e.tooltipStyles).length&&F(e.tooltipStyles),Object.keys(e.tooltipArrowStyles).length&&Z(e.tooltipArrowStyles),z(e.place))}))};(0,react_.useEffect)((()=>{be()}),[Y,q,H,L,d,p,h,R]),(0,react_.useEffect)((()=>{if(!(null==I?void 0:I.current))return()=>null;const e=new ResizeObserver((()=>{be()}));return e.observe(I.current),()=>{e.disconnect()}}),[H,null==I?void 0:I.current]),(0,react_.useEffect)((()=>{var e;const t=document.querySelector(`[id='${a}']`),r=[...ne,t];q&&r.includes(q)||D(null!==(e=ne[0])&&void 0!==e?e:t)}),[a,ne,q]),(0,react_.useEffect)((()=>()=>{X.current&&clearTimeout(X.current),J.current&&clearTimeout(J.current)}),[]),(0,react_.useEffect)((()=>{let e=u;if(!e&&t&&(e=`[data-tooltip-id='${t}']`),e)try{const t=Array.from(document.querySelectorAll(e));ie(t)}catch(e){ie([])}}),[t,u]);const ge=!T&&H&&Y&&Object.keys(U).length>0;return Q?react_.createElement(w,{id:t,role:"tooltip",className:classnames("react-tooltip",E.tooltip,E[n],o,`react-tooltip__place-${M}`,{[E.show]:ge,[E.fixed]:"fixed"===h,[E.clickable]:N}),style:{...L,...U},ref:B},H,react_.createElement(w,{className:classnames("react-tooltip-arrow",E.arrow,l,{[E.noArrow]:x}),style:P,ref:K})):null},x=({content:t})=>react_.createElement("span",{dangerouslySetInnerHTML:{__html:t}}),N=({id:t,anchorId:o,anchorSelect:l,content:n,html:a,render:s,className:u,classNameArrow:d,variant:p="dark",place:v="top",offset:m=10,wrapper:h="div",children:f=null,events:y=["hover"],openOnClick:w=!1,positionStrategy:_="absolute",middlewares:b,delayShow:S=0,delayHide:A=0,float:k=!1,hidden:E=!1,noArrow:N=!1,clickable:O=!1,closeOnEsc:L=!1,style:R,position:$,isOpen:C,setIsOpen:H,afterShow:I,afterHide:W})=>{const[j,q]=(0,react_.useState)(n),[D,B]=(0,react_.useState)(a),[K,X]=(0,react_.useState)(v),[J,M]=(0,react_.useState)(p),[z,U]=(0,react_.useState)(m),[F,P]=(0,react_.useState)(S),[Z,Y]=(0,react_.useState)(A),[G,Q]=(0,react_.useState)(k),[V,ee]=(0,react_.useState)(E),[te,re]=(0,react_.useState)(h),[oe,le]=(0,react_.useState)(y),[ne,ie]=(0,react_.useState)(_),[ce,ae]=(0,react_.useState)(null),{anchorRefs:se,activeAnchor:ue}=g(t),de=e=>null==e?void 0:e.getAttributeNames().reduce(((t,r)=>{var o;if(r.startsWith("data-tooltip-")){t[r.replace(/^data-tooltip-/,"")]=null!==(o=null==e?void 0:e.getAttribute(r))&&void 0!==o?o:null}return t}),{}),pe=e=>{const t={place:e=>{var t;X(null!==(t=e)&&void 0!==t?t:v)},content:e=>{q(null!=e?e:n)},html:e=>{B(null!=e?e:a)},variant:e=>{var t;M(null!==(t=e)&&void 0!==t?t:p)},offset:e=>{U(null===e?m:Number(e))},wrapper:e=>{var t;re(null!==(t=e)&&void 0!==t?t:h)},events:e=>{const t=null==e?void 0:e.split(" ");le(null!=t?t:y)},"position-strategy":e=>{var t;ie(null!==(t=e)&&void 0!==t?t:_)},"delay-show":e=>{P(null===e?S:Number(e))},"delay-hide":e=>{Y(null===e?A:Number(e))},float:e=>{Q(null===e?k:"true"===e)},hidden:e=>{ee(null===e?E:"true"===e)}};Object.values(t).forEach((e=>e(null))),Object.entries(e).forEach((([e,r])=>{var o;null===(o=t[e])||void 0===o||o.call(t,r)}))};(0,react_.useEffect)((()=>{q(n)}),[n]),(0,react_.useEffect)((()=>{B(a)}),[a]),(0,react_.useEffect)((()=>{X(v)}),[v]),(0,react_.useEffect)((()=>{M(p)}),[p]),(0,react_.useEffect)((()=>{U(m)}),[m]),(0,react_.useEffect)((()=>{P(S)}),[S]),(0,react_.useEffect)((()=>{Y(A)}),[A]),(0,react_.useEffect)((()=>{Q(k)}),[k]),(0,react_.useEffect)((()=>{ee(E)}),[E]),(0,react_.useEffect)((()=>{ie(_)}),[_]),(0,react_.useEffect)((()=>{var e;const r=new Set(se);let n=l;if(!n&&t&&(n=`[data-tooltip-id='${t}']`),n)try{document.querySelectorAll(n).forEach((e=>{r.add({current:e})}))}catch(e){console.warn(`[react-tooltip] "${l}" is not a valid CSS selector`)}const i=document.querySelector(`[id='${o}']`);if(i&&r.add({current:i}),!r.size)return()=>null;const c=null!==(e=null!=ce?ce:i)&&void 0!==e?e:ue.current,a=new MutationObserver((e=>{e.forEach((e=>{var t;if(!c||"attributes"!==e.type||!(null===(t=e.attributeName)||void 0===t?void 0:t.startsWith("data-tooltip-")))return;const r=de(c);pe(r)}))})),s={attributes:!0,childList:!1,subtree:!1};if(c){const e=de(c);pe(e),a.observe(c,s)}return()=>{a.disconnect()}}),[se,ue,ce,o,l]);let ve=f;const me=(0,react_.useRef)(null);if(s){const t=s({content:null!=j?j:null,activeAnchor:ce});ve=t?react_.createElement("div",{ref:me,className:"react-tooltip-content-wrapper"},t):null}else j&&(ve=j);D&&(ve=react_.createElement(x,{content:D}));const he={id:t,anchorId:o,anchorSelect:l,className:u,classNameArrow:d,content:ve,contentWrapperRef:me,place:K,variant:J,offset:z,wrapper:te,events:oe,openOnClick:w,positionStrategy:ne,middlewares:b,delayShow:F,delayHide:Z,float:G,hidden:V,noArrow:N,clickable:O,closeOnEsc:L,style:R,position:$,isOpen:C,setIsOpen:H,afterShow:I,afterHide:W,activeAnchor:ce,setActiveAnchor:e=>ae(e)};return react_.createElement(T,{...he})};
